...
def main():
    ...
    players = [
        ...
        # HonestBot(name="Honest_Heidi", chips=1000),
        QLearningBot(name="Bot_Marley", chips=1000, shared_q_table=shared_q_table),
    ...
    # Export Q Table
    os.makedirs(os.path.dirname(q_table_filename), exist_ok=True)
